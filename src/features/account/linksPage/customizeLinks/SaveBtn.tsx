...
const SaveBtn = () => {
  ...
  return (
    <div className="mt-5 w-full border border-transparent border-t-[#d9d9d9] flex justify-center lg:justify-end">
      <button
        type="submit"
        onClick={() =>
          areAllLinksValid &&
        ...
        } text-white flex justify-center items-center mt-5 bg-strongPurple
